---
name: market-copy
description: Marketing copywriting — generate optimized headlines, value props, CTAs, and page copy with before/after examples. Use for /market copy <url> or when rewriting landing/marketing copy for persuasion and clarity.
---
