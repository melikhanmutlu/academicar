---
name: market
description: Marketing suite orchestrator — route /market <command> (audit, quick, copy, emails, social, ads, funnel, competitors, landing, launch, proposal, report, report-pdf, seo, brand) to the right marketing sub-skill. Use when the user wants website marketing analysis, copywriting, email/social/ad content, funnel/CRO/SEO audits, competitive intelligence, launch playbooks, or client proposals/reports.
---
